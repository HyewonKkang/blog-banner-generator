    ...
    ***************************************************************************** */
    ...
    var hsl = function (context, args) {
        ...
        var hue = tokens[0],
            ...
            alpha = tokens[3];
        var h =
            (hue.type === TokenType.NUMBER_TOKEN ? deg(hue.number) : angle.parse(context, hue)) /
            (Math.PI * 2);
        ...
        textList.forEach(function (text) {
            if (styles.textDecorationLine.length || text.trim().length > 0) {
                if (FEATURES.SUPPORT_RANGE_BOUNDS) {
                    textBounds.push(
                        new TextBounds(text, getRangeBounds(context, node, offset, text.length)),
                    );
                } else {
    ...
    var Context = /** @class */ (function () {
        function Context(options, windowBounds) {
            ...
            this.cache =
                (_a = options.cache) !== null && _a !== void 0 ? _a : new Cache(this, options);
        }
                ...
                switch (_t.label) {
                    ...
                    case 1:
                        ...
                        renderOptions = {
                            ...
                            scale:
                                (_m =
                                    (_l = opts.scale) !== null && _l !== void 0
                                        ? _l
                                        : defaultView.devicePixelRatio) !== null && _m !== void 0
                                    ? _m
                                    : 1,
                            x: ((_o = opts.x) !== null && _o !== void 0 ? _o : 0) + left,
                            y: ((_p = opts.y) !== null && _p !== void 0 ? _p : 0) + top,
                            width:
                                (_q = opts.width) !== null && _q !== void 0 ? _q : Math.ceil(width),
                            height:
                                (_r = opts.height) !== null && _r !== void 0
                                    ? _r
                                    : Math.ceil(height),
                        };
